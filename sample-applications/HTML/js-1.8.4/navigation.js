...
//Adding message of Deprecated Library

$("#scania-bootstrap-docs-navigation").after("<div class='alert alert-danger'>All 1.X.X versions of Scania Bootstrap is deprecated and should not be used. Please use <a href='https://scania.com/ux-library'>the new UX Library</a> to find out how to apply the Scania Branding Guidelines to your application. Do you want to upgrade from Scania Bootstrap to Corporate UI? We have some tools that you could be interested in. Feel free to <a href='mailto:corporate-ui@scania.com'>contact us</a>.</div> ");
